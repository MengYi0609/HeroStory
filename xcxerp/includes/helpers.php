...
function code2Session($js_code = null)
{
    if($js_code)
    {
        $url = "https://api.weixin.qq.com/sns/jscode2session?appid=wx216378635167d9b1&secret=651c3a45bb5915d9388e1d6b6a6408ab&js_code=$js_code&grant_type=authorization_code";
